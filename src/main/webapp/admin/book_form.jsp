...
<script type="stylesheet" src="../css/jquery-ui.min.css"></script>
	...
	<div align="center">
		...
		<tr>
			...
			<tr>
				...
				<td align="left"><input type="file" name="bookImage" id="bookImage "size="20">
...
function showImageThumbnail(fileInput){
	...
	reader.onload = function(e){
		$('#thumbnail').arrt('src', e.target.result);
	};
